...
- [x] Adopter-#2 intro calls (T-094/T-095) with Adopter A PM and Adopter B PM (arranged by [Product PM]). Outcome captured in `product/adopter-scouting.md`.
...
| T-091 | `create-project → user-menu` drop-off investigation | 1d | Abhishek + [Product PM] | 20 non-completer sessions from PostHog session replay. Confirm/refute: "users open a project mid-tour and don't return." Follow-up ticket filed. |
...
| T-094 | Adopter-#2 outreach — 2 intro calls | 1d (elapsed) | Abhishek + [Product PM] | 30 min each with Adopter A PM and Adopter B PM. Bring v0.1.0 launch numbers. |
...
- **Day 40 (Fri):** T-093 ADR-0006 draft. First adopter-#2 call (Adopter A PM). Fill in `adopter-scouting.md` from that call.
- **Day 41 (Mon):** Second adopter-#2 call (Adopter B PM). Finish `adopter-scouting.md`. T-096 v0.5 kickoff draft.
...
1. **Pins-first Sprint 09.** Default shape — kickoff doc's Pins design becomes the sprint plan. First pin lands in the example app.
