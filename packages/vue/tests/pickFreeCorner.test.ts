/**
 * pickFreeCorner tests — Vue package copy. Same logic as React; both are
 * kept as per-package sources so adapters can be published independently.
 */
